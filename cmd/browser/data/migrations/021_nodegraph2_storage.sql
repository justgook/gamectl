...
INSERT OR IGNORE INTO nodegraph2_storage (name, data, node_count) VALUES 
  ...
  (
    'default',
    '[{"id":1,"kind":2,"x":409,"y":163,"name":"Resources","codePath":"local:/assets/ng/nodegraph2/array.lua","graphId":0,"graphName":"","inputs":[{"id":1,"name":"Positions","srcNodeId":6,"srcOutputId":1},{"id":2,"name":"Atlas","srcNodeId":2,"srcOutputId":1},{"id":3,"name":"Sprites","srcNodeId":7,"srcOutputId":1}],"outputs":[{"id":1,"name":"slots","value":""}]},{"id":2,"kind":4,"x":80,"y":134,"name":"Atlas","codePath":"","graphId":0,"graphName":"","inputs":[],"outputs":[{"id":1,"name":"","value":"{\"_file\":\"local:/assets/game/the_atlas.qoi\"}"}]},{"id":3,"kind":2,"x":769,"y":125,"name":"Respack Build","codePath":"local:/assets/ng/nodegraph2/respack-build.lua","graphId":0,"graphName":"","inputs":[{"id":1,"name":"schema","srcNodeId":4,"srcOutputId":1},{"id":2,"name":"outputFile","srcNodeId":4,"srcOutputId":2},{"id":3,"name":"slots","srcNodeId":1,"srcOutputId":1}],"outputs":[{"id":1,"name":"outputFile","value":""},{"id":2,"name":"error","value":""}]},{"id":4,"kind":4,"x":409,"y":87,"name":"RSPK","codePath":"","graphId":0,"graphName":"","inputs":[],"outputs":[{"id":1,"name":"schema","value":"{\"_file\":\"local:/assets/respack/game2.rspk.json\"}"},{"id":2,"name":"outputFile","value":"/data.rspk"}]},{"id":5,"kind":1,"x":1019,"y":134,"name":"THE BUILD","codePath":"","graphId":0,"graphName":"","inputs":[{"id":1,"name":"file","srcNodeId":3,"srcOutputId":1},{"id":2,"name":"error","srcNodeId":3,"srcOutputId":2}],"outputs":[]},{"id":6,"kind":4,"x":80,"y":58,"name":"Positions","codePath":"","graphId":0,"graphName":"","inputs":[],"outputs":[{"id":1,"name":"","value":"{\"entity_ids\":[],\"components\":[]}"}]},{"id":7,"kind":2,"x":80,"y":210,"name":"Demo UVs","codePath":"local:/assets/ng/nodegraph2/uvs.lua","graphId":0,"graphName":"","inputs":[],"outputs":[{"id":1,"name":"uvs","value":""}]}]',
    7
  );
