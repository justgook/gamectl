...
- For `cmd/browser` view/UI work, consult legacy rules in `docs/legacy/views/VIEW_RULES.md` until a current replacement exists. Treat the clarified UI vocabulary/rules as canonical once converted out of legacy.
